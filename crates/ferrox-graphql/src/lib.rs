...
/// Helper to build a basic Ferrox GraphQL schema without mutations or subscriptions
...
pub fn setup() {
    println!("ferrox-graphql initialized: Provides async-graphql Schema builders.");
}
