//! # Ferrox Webhooks (`ferrox-webhooks`)
//!
//! `ferrox-webhooks` provides an outgoing webhook delivery engine featuring HMAC-SHA256 request signing and automatic exponential backoff retries.
