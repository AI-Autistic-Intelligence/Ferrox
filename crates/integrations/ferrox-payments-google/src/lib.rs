//! # Ferrox Payments Google (`ferrox-payments-google`)
//!
//! `ferrox-payments-google` provides Google Pay API verification and Google Play Store in-app purchase validation for backend services.
