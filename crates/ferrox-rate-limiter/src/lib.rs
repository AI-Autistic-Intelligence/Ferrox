//! # Ferrox Rate Limiter (`ferrox-rate-limiter`)
//!
//! `ferrox-rate-limiter` provides distributed rate limiting middleware (token bucket, fixed window) to protect API endpoints against DDoS and abuse.
